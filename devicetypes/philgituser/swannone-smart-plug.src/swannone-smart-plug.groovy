...
metadata {
    definition (name: "SwannOne Smart Plug", namespace: "philgituser", author: "Philip", ocfDeviceType: "oic.d.switch", runLocally: false, minHubCoreVersion: '000.019.00012', executeCommandsLocally: true) {
        capability "Actuator"
...
def parse(String description) {
    ...
    if (event) {
        if (event.name == "power") {
            def powerValue
            //Philip's only change was to remove the divisor
